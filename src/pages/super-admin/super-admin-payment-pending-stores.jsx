...
import { deletSingleStoreFn, getAllStorePendingFn, getAllStoresFn, updatePaidStoreStatusFn, updateStoreStatusFn } from "@/services/super-admin/store-service";
import ShimmerTableBody from "@/shimmer/table-shimmer";
import { Eye } from "lucide-react";
import { useCallback, useEffect, useState } from "react";
import { Link } from "react-router-dom";

export default function SuperAdminPaymentPendingStores() {
    ...
    const getData = useCallback(() => {
        getAllStorePendingFn({ search, page: currentPage }).then((data) => {
    ...
    const updateStatus = (store_id) => {
        getAllStorePendingFn(store_id).then(() => {
            getData();
        })
    }
    ...
    return (
        <div>
            <Title title={"Pending Payment Stores"} />
